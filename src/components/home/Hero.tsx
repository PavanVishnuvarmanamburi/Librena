      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button 
              onClick={() => navigate(isAuthenticated ? '/comparison' : '/login')}
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white button-hover"
            >
            ...
            <Button 
              ...
              className="button-hover border-2"
            >
              Learn More About Us
            </Button>
          </div>
